      ...
      <div className="container relative" ref={parallexRef}>
        <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[3.875rem] md:mb-20 lg:mb-[6.25rem]">
          <h1 className="h1 mb-6">
            Create AI Call Agents Within Seconds With {` `}
          ...
          Spin up AI-powered call agents in seconds — with ready-to-use integrations that connect to your tools instantly
          </p>
          <Button href="/" white>
            Get started
          </Button>
